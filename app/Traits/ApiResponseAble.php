...
trait ApiResponseAble
{
     ...
     * @author <ferasbbm>
     */
    protected function ApiErrorResponse($errors = null, $message = null,int $statusCode = Response::HTTP_BAD_REQUEST): JsonResponse
    {

        $message = $message ??  trans('api.something_error');
        $response = $this->errorResponse($statusCode, $errors, $message);
    ...
    {
        $response = $this->errorResponse(Response::HTTP_FORBIDDEN, null, trans('general.unAuthorized'));
